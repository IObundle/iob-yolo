...
`define LAYER_17 (13*13*255)
`define LAYER_19 (13*13*128)
`define TOTAL_FM ((`IMAGE_INPUT+`NETWORK_INPUT_AUX+`NETWORK_INPUT+`LAYER_1+`LAYER_3+`LAYER_5+`LAYER_7+`LAYER_9+`LAYER_10+`LAYER_11+`LAYER_12+`LAYER_13+`LAYER_14+`LAYER_15+`LAYER_16+`LAYER_17+`LAYER_19)*2)
...
`define TOTAL_WEIGHTS ((`WEIGHTS_LAYER_1+`WEIGHTS_LAYER_3+`WEIGHTS_LAYER_5+`WEIGHTS_LAYER_7+`WEIGHTS_LAYER_9+`WEIGHTS_LAYER_11+`WEIGHTS_LAYER_13+`WEIGHTS_LAYER_14+`WEIGHTS_LAYER_15+`WEIGHTS_LAYER_16+`WEIGHTS_LAYER_19)*2)
...
`endif
   ...
   //define parameters
   parameter file_ddr = {`STRINGIFY(`FILES_DIR), "layer19.hex"};
