...
module tiny_yolov3_tb;
   ...
   //define parameters
   parameter file_ddr = {"../../../../tiny_yolov3_", `STRINGIFY(`MIG_BUS_W), "_x", `STRINGIFY(`nYOLOmacs), ".hex"};
...
`ifdef VCD
      $dumpfile("system.vcd");
      $dumpvars(0, tiny_yolov3_tb.uut.versat);
      $dumpvars(0, tiny_yolov3_tb.uut.ext_mem0);
`endif
