...
#define DATA_LAYER_11 (LAYER_11_W*LAYER_11_W*LAYER_11_NUM_KER)

//Total
#define TOTAL_WEIGHTS (WEIGHTS_LAYER_1 + WEIGHTS_LAYER_3 + WEIGHTS_LAYER_5 + WEIGHTS_LAYER_7 + WEIGHTS_LAYER_9 + WEIGHTS_LAYER_11)
