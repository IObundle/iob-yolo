...
layer3_w = 32 + 32*3*3*16
layer5_w = 64 + 64*3*3*32
layer7_w = 128 + 128*3*3*64
layer9_w = 256 + 256*3*3*128
layer11_w = 512 + 512*3*3*256
layer_w_total = layer1_w + layer3_w + layer5_w + layer7_w + layer9_w + layer11_w
