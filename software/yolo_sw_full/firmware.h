...
#define DATA_LAYER_3 ((LAYER_3_W+LAYER_3_NEXT_STRIDE+2*LAYER_3_NEXT_PADD)*160*LAYER_3_NUM_KER)
...
#define DATA_LAYER_4 ((LAYER_3_W/(1+LAYER_4_DOWNSAMPLE)+2)*84*LAYER_3_NUM_KER)
...
#define DATA_LAYER_5 ((LAYER_5_W+LAYER_5_NEXT_STRIDE+2*LAYER_5_NEXT_PADD)*84*LAYER_5_NUM_KER)
...
#define DATA_LAYER_6 ((LAYER_5_W/2+(1+LAYER_6_DOWNSAMPLE))*46*LAYER_5_NUM_KER)
...
#define DATA_LAYER_7 ((LAYER_7_W+LAYER_7_NEXT_STRIDE+2*LAYER_7_NEXT_PADD)*44*LAYER_7_NUM_KER)
...
#define DATA_LAYER_8 ((LAYER_7_W/(1+LAYER_8_DOWNSAMPLE)+2)*26*LAYER_7_NUM_KER)
