...
#define NETWORK_INPUT ((NTW_IN_W+2*NTW_IN_PAD)*(NTW_IN_W+2*NTW_IN_PAD)*NTW_IN_C)

//Layer1 (conv)
#define DATA_LAYER_1 ((NTW_IN_W+NTW_IN_NEXT_STRIDE+2*NTW_IN_NEXT_PADD)*(NTW_IN_W+NTW_IN_NEXT_STRIDE+2*NTW_IN_NEXT_PADD)*NTW_IN_NUM_KER)
...
#define DATA_LAYER_2 ((LAYER_2_W/(1+LAYER_2_DOWNSAMPLE)+2)*(LAYER_2_W/(1+LAYER_2_DOWNSAMPLE)+2)*LAYER_2_NUM_KER)
